...
const NAV_ITEMS = [
  ...
  { href: '/generate/multi',         label: '一括生成',              icon: LayoutGrid,      group: 'SNSコンテンツ生成' },
  { href: '/generate/instagram',       label: 'Instagram台本',         icon: Instagram,       group: 'SNSコンテンツ生成' },
  { href: '/generate/instagram-story', label: 'Instagramストーリーズ', icon: Images,          group: 'SNSコンテンツ生成' },
  { href: '/generate/meta-ad',         label: 'Meta広告コピー',        icon: Megaphone,       group: 'SNSコンテンツ生成' },
